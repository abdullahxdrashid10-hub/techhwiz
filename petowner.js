document.addEventListener('DOMContentLoaded', () => {
  ...
  const products = [
    ...
    { name:'Interactive Puzzle Ball',    cat:'Toys',                price:15.99, badge:'Top Rated',    img:'assets/puzzle ball.png',             desc:'Treat-dispensing interactive puzzle ball that keeps pets mentally stimulated.' },
